...
class _WP_Admin_Page {
    ...
    protected function hooks () : void
    {
        ...
        add_action( 'admin_menu' , [$this, 'add_menu_item'], $submenu_position );
    ...
    public function enqueue_assets () : void
    {
        ...
        wp_enqueue_script(
            ...
            '/wp-content/plugins/rent-rabbit/includes/panel/assets/js/admin/fields.min.js',
            $deps,
     ...
     * @return void
     */
    protected function do_setup_page_hooks () : void
    {
     ...
     * @throws Exception
     */
    public function add_subtitle ( $data ) : void
    {
        $defaults = [
            'tab'  => $this->default_tab,
            'desc' => '',
    ...
    public function set_tab ( $data ) {
        $defaults = [
            ...
            'name'          => '',
            'desc'          => '',
            'submit_label'  => __( 'Save Changes', 'rent-rabbit' ),
            'fields'        => [],
        ];
        $data = array_merge( $defaults, $data );

        if (!empty($data['fields']['disable']) && $data['fields']['disable'] === true) {
            return null;
        }
